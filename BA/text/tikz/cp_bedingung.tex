...
\tikzstyle{rechteck_oben}=[rechteck, minimum height=0cm, minimum width=2cm, fill=mygray, draw=black]
...
\node [rechteck_unten, minimum width=2cm, text width=2.5cm] (11) at (1.5,4.5) {Abhängige Variable $Y1$};
...
\node[] (13) at (5.35,0.5) {Kontrollierte Umgebung};
\node(14) at (-6,1.65) {};
