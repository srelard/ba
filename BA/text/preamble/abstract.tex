...
\begin{tabular}{c}
\input{BA/text/tikz/zielscheibe/ziel1.tex}
\end{tabular}
...
\begin{subtable}[t]{0.22\linewidth}
\begin{tabular}{c}
\input{BA/text/tikz/zielscheibe/ziel2.tex}
\end{tabular}
...
\begin{subtable}[t]{0.22\linewidth}
\begin{tabular}{c}
\input{BA/text/tikz/zielscheibe/ziel3.tex}
\end{tabular}
...
\begin{subtable}[t]{0.22\linewidth}
\begin{tabular}{c}
\input{BA/text/tikz/zielscheibe/ziel4.tex}
\end{tabular}
...
\input{BA/text/tikz/zielscheibe/ziel1.tex}  & \input{BA/text/tikz/zielscheibe/ziel2.tex}      & \input{BA/text/tikz/zielscheibe/ziel3.tex} & \input{BA/text/tikz/zielscheibe/ziel4.tex} \\
&&&\\
...
&&Geschäftsmodell&\\ 
&&Domain \ar[u]\ar[dr]&\\
&Field intern \ar[ur]\ar[dl]&&Person \ar[ll]\\
Field extern  \ar@/{}_{-3pc}/[uurr]&&&\\
} 
