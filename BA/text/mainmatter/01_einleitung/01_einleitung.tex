...
\label{tab: myLabel}
\resizebox{\textwidth}{!}{%
\begin{tabular}{C{.4\textwidth}C{.05\textwidth}C{.4\textwidth}}
\input{BA/text/tikz/systemmodell.tex}  & $\Longrightarrow$   \quad\quad\quad\quad\quad\quad\quad\quad\quad\quad   & \input{BA/text/tikz/systemmodell.tex}  \\
\end{tabular}}
\end{table}